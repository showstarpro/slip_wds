...
def get_shared_folder() -> Path:
    user = os.getenv("USER")
    if Path("/lpai/volumes/so-volume-ga/lhp/slip/checkpoint/").is_dir():
        p = Path(f"/lpai/volumes/so-volume-ga/lhp/slip/checkpoint/experiments")
