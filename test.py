...
model_slip = getattr(models, "CLIP_VITB16")(ssl_mlp_dim=4096, ssl_emb_dim=256)
vision_tower = model_slip.visual
vision_tower_state_dict = vision_tower.state_dict()
torch.save(model_slip.state_dict(),'/lpai/volumes/so-volume-ga/lhp/slip/clip_vitb_transformer/checkpoint_best.pt' )
...
print(msg)
model.save_pretrained("/lpai/volumes/so-volume-ga/lhp/models/clip_vitb_transformer")
